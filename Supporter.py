...
if rd==1:
    ...
    fp=PhotoImage(file="C:\\Users\\aravi\\OneDrive\\Pictures\\MainpageBG2.png")
    bl=Label(rt,image=fp)
    bl.place(x=0,y=0,relwidth=1,relheight=1)
    c.pack()
elif rd==2:
    c=Canvas(rt,height=1500,width=1500)
    fp=PhotoImage(file="C:\\Users\\aravi\\OneDrive\\Pictures\\HomePageBG5.png")
    bl=Label(rt,image=fp)
    bl.place(x=0,y=0,relwidth=1,relheight=1)
    c.pack()
elif rd==3:
    c=Canvas(rt,height=1500,width=1500)
    fp=PhotoImage(file="C:\\Users\\aravi\\OneDrive\\Pictures\\MainPageBG.png")
    bl=Label(rt,image=fp)
    bl.place(x=0,y=0,relwidth=1,relheight=1)
    c.pack()
